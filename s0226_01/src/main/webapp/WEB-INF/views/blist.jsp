...
<head>
  ...
  <title>VLAST Shop - 게시판 리스트</title>
  ...
  <div class="board-container">
    ...
    <table class="board-table">
      ...
      <c:forEach var="board" items="${list}">
        <tr>
          <td>${board.bno}</td>
          <td class="title"><a href="/board/bview?id=${board.bno}">${board.btitle}</a></td>
      ...
      $(function(){
    	 $(document).on("click",".delBtn",function(){
    		...
    		if(confirm("회원을 삭제하시겠습니까?")){
    			//insert-post, update-put, delete-delete : get방식 사용하지 말것. -> 해킹위험
    			//select : get방식 
