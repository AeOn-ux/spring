...
<body>
  ...
  <div class="container">
    ...
    <div class="btn-box">
      <a href="/member/mlist"><button class="btn cancel">회원목록</button></a>
      
      <a href="/member/mupdate?id=${member.id}"><button type="button" class="btn submit" onclick="memBtn()">회원수정</button></a>
